...
const RULES = [
  ...
  // ─── LDAP Injection ──────────────────────────────────────────────────────
  {
    ...
    severity: 'high',
    pattern: /(\(\s*\||\(\s*&|\*\s*\)|\)\s*\(|\\00)/gi,
    targets: ['body', 'query'],
    description: 'LDAP filter injection via special characters and null bytes'
  },
  ...
  // ─── NoSQL Injection ─────────────────────────────────────────────────────
  {
    ...
    severity: 'critical',
    pattern: /(\$where|\$ne|\$gt|\$lt|\$gte|\$lte|\$in|\$nin|\$regex|\$exists|\$or|\$and|\$not|\$nor)\s*:/gi,
    targets: ['body', 'query'],
    description: 'MongoDB/NoSQL operator injection in JSON body or query params'
  },
  ...
  // ─── Prototype Pollution ─────────────────────────────────────────────────
  {
    ...
    targets: ['body', 'query', 'url'],
    description: 'JavaScript prototype pollution via __proto__ or constructor.prototype'
  },
  ...
  // ─── Server-Side Template Injection (SSTI) ───────────────────────────────
  {
    ...
    targets: ['body', 'query'],
    description: 'Server-side template injection via Jinja2, Twig, EL, or similar syntax'
  },
  ...
  // ─── Log4Shell ───────────────────────────────────────────────────────────
  {
    ...
    category: 'log4shell',
    severity: 'critical',
    pattern: /\$\{[jJ][nN][dD][iI]\s*:/g,
    targets: ['body', 'query', 'headers', 'url'],
    description: 'Log4j JNDI lookup injection (Log4Shell CVE-2021-44228)'
  },
  ...
  // ─── JWT Manipulation ────────────────────────────────────────────────────
  {
    ...
    description: 'JWT with alg:none — signature bypass attempt'
  }
]
